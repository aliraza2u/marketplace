...
const Button: FC<ICustomButtonProps> = ({
  ...
  return (
    <button
      className={` ${
        type === "rounded"
          ? "rouded-button px-6 py-2 lg:px-[32px] lg:py-3 text-white text-lg font-medium flex-shrink-0 flex-grow-0 basis-[150px] lg:flex-shrink-[auto] lg:flex-grow-[auto] lg:basis-[auto]"
          : type === "transparent"
